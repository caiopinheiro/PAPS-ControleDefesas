...
(function ($) {
	...
	$.fn.countdown = function( method /*,options*/ ) {  
		...
		var defaults = {
				date: (new Date()),
				updateTime: 1000,
				htmlTemplate: "<span class=\"number\">%{d}</span> <span class=\"cd-time\">:</span> <span class=\"number\">%{h}</span> <span class=\"cd-time\">:</span> <span class=\"number\">%{m}</span> <span class=\"cd-time\">:</span> <span class=\"number\">%{s}</span> <span class=\"cd-time\"></span>",
				minus: false,
				onChange: null,
				onComplete: null,
				onResume: null,
