...

{
	...
	{	
		error_log('PbookingModelSurvey created');
	...
	*/
	...
	{
		Pbdebug::log_msg('PbbookingModelSurvey::save_survey() - with data '.json_encode($survey),'com_pbbooking');
		$db = &JFactory::getDbo();
		...
		if ($ex_survey) {
			Pbdebug::log_msg('PbbookingModelSurvey::save_survey() - survey already exists','com_pbbooking');
			return false;
		}
