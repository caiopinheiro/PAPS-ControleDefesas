...
<div class="cpanel">
		...
		<div class="icon-wrapper">
			<div class="icon">
				...
				<span><?php echo JText::_( 'Relatório de Defesas Por Período' ); ?></span></a>
			</div>
		</div>
		...
		<div class="icon-wrapper">
			<div class="icon">
				...
				<img width="32" height="32" border="0" src="components/com_controledefesas/assets/images/historico.gif">
				<span><?php echo JText::_( 'Listar Defesas Por Aluno' ); ?></span></a>
			</div>
		</div>
		
		<div class="icon-wrapper">
			<div class="icon">
				<a href="index.php?option=com_controledefesas&view=listapendente">
				<img width="32" height="32" border="0" src="components/com_controledefesas/assets/images/aprovarcandidatos.png">
				<span><?php echo JText::_( 'Listar Pendentes de Defesa'); ?></span></a>
			</div>
		</div>
