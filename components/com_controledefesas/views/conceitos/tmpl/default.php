...
<hr />
	...
	?>
		<h3 style="background-color: #f00; color: black">   Obs.: Não é possivel lançar o conceito, pois a 
			defesa ainda não foi realizada. </h3>
	<?php 
	}

	else if ($Defesa[0]->conceito != ''){ 
	?>
		<h3 style="background-color: #00FF00; color: black">   Obs.: Conceito já foi Lançado. </h3>
	<?php 
		}
	...
	?>
		<h3 style="background-color: #f00; color: black">   Obs.: Não é possivel lançar o conceito, pois não 
			consta no Banco de Dados a existência de uma Banca Avaliadora. </h3>
	<?php 
		}

		else if(($Defesa[0]->tipoDefesa = 'T' OR $Defesa[0]->tipoDefesa = 'D')  && ($Defesa[0]->status_banca == NULL)){
	?>
		<h3 style="background-color: #f00; color: black">   Obs.: Não é possivel lançar o conceito, pois a Banca Avaliadora
			ainda não foi aprovada pelo Coordenador. </h3>
	<?php 
		}
	?>
	<br>
