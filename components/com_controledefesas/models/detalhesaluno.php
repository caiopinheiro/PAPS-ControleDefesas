...
class ControledefesasModelDetalhesAluno extends JModelItem
{
	...
	public function getMembrosBanca($idAluno){
		...
		$sqlOrientador = "select concat('Prof.(a) ', p.nomeProfessor) nome, 'P' funcao , 'PPGI/UFAM' filiacao, p.email, '' tipoDefesa 
		...
		$sql = "SELECT mb.nome, bhmb.funcao, mb.filiacao, mb.email, d.tipoDefesa FROM #__banca_controledefesas AS b 
