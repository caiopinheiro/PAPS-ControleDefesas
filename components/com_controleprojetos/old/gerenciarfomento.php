...
function listarFomentos($nome = ""){
    ...
    $sql = "SELECT * FROM #__contproj_agencias WHERE nome LIKE '%$nome%' ORDER BY nome";
	...
	<thead>
      <tr bgcolor="#002666">
        ...
        <th width="12%" align="center"><font color="#FFC000">Sigla</font></th>
      </tr>
     </thead>
     <tbody>
  ...
  if($idFomento == ""){//condicao se o cadastro for novo
      ...
      $repetido = $database->loadObjectList();
        ...
        return 1;
            ...
            JFactory::getApplication()->enqueueMessage(JText::_('Cadastro nao realizado, nome e/ou sigla ja cadastrados.'));
            return (0);
        }
    }
    ...
    $repetido = $database->loadObjectList();
        ...
        JFactory::getApplication()->enqueueMessage(JText::_('Edição não realizada, nome e/ou sigla ja cadastrados!'));
        return (1);
        }
        else{
