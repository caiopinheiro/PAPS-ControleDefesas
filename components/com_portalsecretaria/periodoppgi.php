...
// EXCLUIR DISCIPLINA DO PER√çODO
...
function imprimirPagela($idPeriodo, $idDisciplina, $turma, $tipo){
	...
	$optionsTable = array('fontSize'=>8, 'titleFontSize'=>8, 'xPos'=>'center', 'width'=>800, 'cols'=>array('Ordem'=>array('width'=>35, 'justification'=>'center'),'Matr√É¬≠cula'=>array('width'=>70, 'justification'=>'center'), 'Nome do Aluno'=>array('width'=>170), 'Total de Faltas'=>array('width'=>50, 'justification'=>'center')));
	...
	$cont = 1;
	$cols = array('Ordem'=>'Ordem', 'MatrÌ≠cula'=>'MatrÌ≠cula', 'Nome do Aluno'=>'Nome do Aluno','Dia 1'=>'     ','Dia 2'=>'','Dia 3'=>'','Dia 4'=>'','Dia 5'=>'','Dia 6'=>'','Dia 7'=>'','Dia 8'=>'','Dia 9'=>'','Dia 10'=>'','Dia 11'=>'','Dia 12'=>'','Dia 13'=>'','Dia 14'=>'','Dia 15'=>'','Dia 16'=>'','Dia 17'=>'','Dia 18'=>'','Dia 19'=>'','Dia 20'=>'','Total de Faltas'=>'Total de Faltas' );
	foreach( $alunos as $aluno )
	{
		$listaAlunos[] = array('Ordem'=>$cont, 'Matr√©¬≠cula'=>$aluno->matricula, 'Nome do Aluno'=>utf8_decode($aluno->nome),'Dia 1'=>'','Dia 2'=>'','Dia 3'=>'','Dia 4'=>'','Dia 5'=>'','Dia 6'=>'','Dia 7'=>'','Dia 8'=>'','Dia 9'=>'','Dia 10'=>'','Dia 11'=>'','Dia 12'=>'','Dia 13'=>'','Dia 14'=>'','Dia 15'=>'','Dia 16'=>'','Dia 17'=>'','Dia 18'=>'','Dia 19'=>'','Dia 20'=>'','Total de Faltas'=>'' );
		$cont++;
	}
	...
	$pdf->addText(190,40,8,'Av. Rodrigo Ot·vio, 6.200 - Campus Universit·rio Senador Arthur VirgÌ≠lio Filho - CEP 69077-000 - Manaus, AM, Brasil',0,0);
...
function imprimirBoletim($idPeriodo, $idDisciplina, $turma, $tipo) {
	...
	$optionsText = array('justification'=>'center', 'spacing'=>1.5);
	$dados = array('justification'=>'justify', 'spacing'=>1.0);
	$optionsTable = array('fontSize'=>8, 'titleFontSize'=>8, 'xPos'=>'center', 'width'=>500, 'cols'=>array('Ordem'=>array('width'=>35, 'justification'=>'center'),'MatrÌ≠cula'=>array('width'=>70, 'justification'=>'center'), 'Nome do Aluno'=>array('width'=>275), 'Conceito'=>array('width'=>50, 'justification'=>'center'), 'FrequÍncia(%)'=>array('width'=>70, 'justification'=>'center')));
	...
	$pdf->ezText('');  //Para quebra de linha
	$pdf->ezText("<b>CrÈditos:</b> ". $turmas[0]->creditos,10,$dados);
	...
	$cont = 1;
	foreach( $alunos as $aluno ) {
		$listaAlunos[] = array('Ordem'=>$cont, 'MatrÌ≠cula'=>$aluno->matricula, 'Nome do Aluno'=>utf8_decode($aluno->nome),'Conceito'=>$aluno->conceito,'FrequÍncia(%)'=>number_format($aluno->frequencia,2));
		$cont++;
	}
	...
	$pdf->addText(80,40,8,'Av. Rodrigo Ot·vio, 6.200 - Campus Universit·rio Senador Arthur VirgÌlio Filho - CEP 69077-000Ç Manaus, AM, Brasil',0,0);
...
function listarMatriculas($idPeriodo, $anoIngresso, $curso) {
    ...
    <!-- EFEITO TOGGLE [MATR√É¬çCULAS PENDENTES] -->
    ...
    <!-- LISTAGEM DOS N√ÉO MATRICULADOS -->
    <?php
	...
	<br />
    <span class="label label-inverse">Total de matr√≠culas: <?php echo sizeof($alunos);?></span>
...
function addDiscPeriodo($periodo, $disciplinas, $idDisciplina, $turma, $editar) {
	...
	<table width="100%" cellpadding="6">
		<tr style="background-color:#7196d8; color:#FFF; font-weight:bold;">
			<td colspan="4">Informa√ß√µes da Disciplina</td>
		</tr>
		<tr>
...
function listarPeriodo($periodos, $ano, $resultado) {
	...
	<script language="JavaScript">
		...
		function EncerrarInscricao(formPeriodo, idPeriodo) {
			var confirmar = confirm('Deseja encerrar o per√≠do de Inscri√ß√£o?');
                ...
                <td>
                	<?php if ($periodo->status == 0) { 
						...
						if ($periodo->inscricao == 0) { ?> 
                            ...
                            <img border='0' src='components/com_portalsecretaria/images/cadeado_fechado.gif' title='Abrir para  Inscri√ß√£o'>
                        </a>
                        <?php } else { ?>
                            ...
                            <img border='0' src='components/com_portalsecretaria/images/cadeado_aberto.gif' title='Fechar para  Inscri√ß√£o'> 
                        </a>
                    <?php } } ?>           	
                </td>
				<td>
...
function imprimirOferta($disciplinas, $periodo) {
	...
	$optionsText = array('justification'=>'center', 'spacing'=>1.5);
	$dados = array('justification'=>'justify', 'spacing'=>1.0);
	$optionsTable = array('fontSize'=>8, 'titleFontSize'=>8, 'xPos'=>'center', 'width'=>800, 'cols'=>array('C√≥digo'=>array('width'=>50, 'justification'=>'center'),'Disciplina'=>array('width'=>235), 'Turma'=>array('width'=>35, 'justification'=>'center'), 'Professor'=>array('width'=>140), 'CR'=>array('width'=>25, 'justification'=>'center'), 'CH'=>array('width'=>25, 'justification'=>'center'), 'Hor√°rio'=>array('width'=>145, 'justification'=>'center'), 'Sala'=>array('width'=>145, 'justification'=>'center')));
	...
	$pdf->ezText('<b>Instituto de Computa√ß√£o - IComp</b>',12,$optionsText);
	$pdf->ezText('<b>Programa de P√≥s-Gradua√ß√£o em Inform√°tica - PPGI</b>',12,$optionsText);
	$pdf->ezText('');  //Para quebra de linha
	$pdf->ezText('');  //Para quebra de linha
	$pdf->ezText('');  //Para quebra de linha
	$pdf->ezText('');  //Para quebra de linha
	$pdf->setLineStyle(3);
	$pdf->line(20, 450, 820, 450);
	$pdf->ezText("<b>OFERTA DE DISCIPLINAS DO PER√çODO ".$periodo->periodo."</b>",14,$optionsText);
	...
	foreach( $disciplinas as $disciplina)
	{
		$disciplinasMatriculas[] = array('C√≥digo'=>$disciplina->codigo, 'Disciplina'=>utf8_decode($disciplina->nomeDisciplina), 'Turma'=>$disciplina->turma,'CR'=>$disciplina->creditos, 'CH'=>$disciplina->carga, 'Professor'=>utf8_decode($disciplina->professor), 'Hor√°rio'=>utf8_decode($disciplina->horario), 'Sala'=>utf8_decode($disciplina->sala));
	}

	$pdf->ezTable($disciplinasMatriculas,$cols,'',$optionsTable);

	$pdf->line(20, 55, 820, 55);
	$pdf->addText(270,40,8,'Av. Rodrigo Ot√°vio, 6.200 - Coroado - Campus Universit√°rio - CEP 69077-000 - Manaus, AM, Brasil',0,0);
	...
	<form method="post" name="formAproveitamento" action="index.php?option=com_portalsecretaria&Itemid=<?php echo $Itemid;?>">
		...
		<?php
			...
			if ($myDisciplinas) { ?>
                ...
                <table width="100%" cellpadding="6">
                    <tr style="background-color:#7196d8; color:#FFF; font-weight:bold;">
                        <td colspan="10">Disciplinas Solicitadas e N√£o Julgadas</td>
                    </tr>
                    <tr bgcolor="#eaeaea">
                        <td align="center" width="6%">Julgar</td>
                        <td align="center" width="8%">Pedido</td>
                        <td align="center" width="8%">C√≥digo</td>
                        <td align="center" width="9%">Per√≠¬≠odo</td>
                        <td align="center" width="39%">Disciplina</td>
                        <td align="center" width="8%">Cr√©ditos</td>
		...
		<?php
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2">
				...
				<tr>
					...
					<td align="center" width="8%" bgcolor="#CCCCCC"><strong>C√É¬≥digo</strong></td>
...
function imprimirAproveitamento($aluno, $periodo) {
	...
	$curso = array (1 => "Mestrado",2 => "Doutorado",3 =>"Especial");
	$resultado = array (0 => "N√£o Julgado",1 => "Deferido",2 =>"Indeferido");
	...
	$optionsText = array('justification'=>'center', 'spacing'=>1.5);
	$dados = array('justification'=>'justify', 'spacing'=>1.0);
	$optionsTable = array('fontSize'=>8, 'titleFontSize'=>8, 'xPos'=>'center', 'width'=>615, 'cols'=>array('C√≥digo'=>array('width'=>50, 'justification'=>'center'),'Disciplina'=>array('width'=>205), 'Semestre'=>array('width'=>50, 'justification'=>'center'), 'Conceito'=>array('width'=>50, 'justification'=>'center'), 'CR'=>array('width'=>25, 'justification'=>'center'), 'CH'=>array('width'=>25, 'justification'=>'center'), 'Freq(%)'=>array('width'=>50, 'justification'=>'center'), 'Tipo'=>array('width'=>30, 'justification'=>'center'), 'Resultado'=>array('width'=>60, 'justification'=>'center')));
	...
	$pdf->addText(430,632,10,"<b>MatrÌ≠cula: </b> $aluno->matricula",0,0);
	$pdf->ezText('');  //Para quebra de linha
	...
	$pdf->addText(430,584,10,"<b>PerÌodo:</b> ". $idPeriodo->periodo,0,0);
	$pdf->ezText('');

	foreach( $disciplinas as $disciplina) {
		if($disciplina->tipoAproveitamento == 1 || $disciplina->tipoAproveitamento == 3)
		   $disciplinasMatriculas[] = array('CÛdigo'=>$disciplina->codigo, 'Disciplina'=>utf8_decode($disciplina->nomeDisciplina), 'Semestre'=>$disciplina->periodoCursado,'CR'=>$disciplina->creditos, 'CH'=>$disciplina->carga, 'Conceito'=>utf8_decode($disciplina->conceito), 'Freq(%)'=>utf8_decode($disciplina->frequencia), 'Tipo'=>utf8_decode($disciplina->tipoAproveitamento), 'Resultado'=>$resultado[$disciplina->resultado]);
		else
		   $disciplinasMatriculas[] = array('CÛdigo'=>$disciplina->codExterno, 'Disciplina'=>utf8_decode($disciplina->disciplina), 'Semestre'=>$disciplina->periodoCursado,'CR'=>$disciplina->credExterno, 'CH'=>$disciplina->cargaExterno, 'Conceito'=>utf8_decode($disciplina->conceito), 'Freq(%)'=>utf8_decode($disciplina->frequencia), 'Tipo'=>utf8_decode($disciplina->tipoAproveitamento), 'Resultado'=>$resultado[$disciplina->resultado]);
	}
	...
	$pdf->ezText('1 - Cursada neste Curso de PÛs-GraduaÁ„o como aluno regular ou aluno especial');
	$pdf->ezText('2 - Cursada em outros Cursos de PÛs-GraduaÁ„o como aluno especial ou regular');
	$pdf->ezText('3 - Ministrada no IComp/UFAM por pelo menos um semestre para aproveitamento em Est·gio em DocÍncia');
	$pdf->ezText('4 - Professores de outras IES reconhecidas que tenham exercido suas atividades na ·rea de Inform·tica');
	$pdf->ezText('5 - Aluno que tenha ministrado aulas em cursos de Inform·tica ou ComputaÁ„o em outras IES reconhecidas');
	$pdf->ezText('6 - Cursada em curso de GraduaÁ„o com equivalÍncia ‡s disciplinas do Mestrado');
	...
	$pdf->line(20, 55, 580, 55);
	$pdf->addText(80,40,8,'Av. Rodrigo Ot·vio, 6.200 - Campus Universit·rio Senador Arthur VirgÌ≠lio Filho - CEP 69077-000 - Manaus, AM, Brasil',0,0);
	$pdf->addJpegFromFile('components/com_portalsecretaria/images/icon_telefone.jpg', 140, 30, 8, 8);
	$pdf->addJpegFromFile('components/com_portalsecretaria/images/icon_email.jpg', 229, 30, 8, 8);
	$pdf->addJpegFromFile('components/com_portalsecretaria/images/icon_casa.jpg', 383, 30, 8, 8);
	$pdf->addText(150,30,8,'Tel. (092) 3305 1193       E-mail: secretaria@icomp.ufam.edu.br        www.ppgi.ufam.edu.br',0,0);
