		...
		<table width='100%' border='0' cellspacing='1' cellpadding="0" id="tablesorter-imasters" class="tabela">
			<thead>
				<tr bgcolor="#002666">
					...
					<th width="6%" align="center"><font color="#FFC000">Data de Solicitação</font></th>
		...
		<div id="toolbar-box"><div class="m"><div class="toolbar-list" id="toolbar">
			<div class="cpanel2">
				<div class="icon" id="toolbar-print">
					...
					<span class="icon-32-copy"></span><?php echo JText::_( 'Imprimir' ); ?></a>
				</div>
