...
<form method="post" name="form" enctype="multipart/form-data" action="index.php?option=com_portalsecretaria&Itemid=<?php echo $Itemid;?>">
	...
	<fieldset>
		...
		<tr>
			...
			<select name="fecha">
				...
				<?php						
					$sql = "SELECT DISTINCT DATE_FORMAT(dataSolicitacao, '%m/%Y') as dataSolicitacao from #__trancamentos ORDER BY dataSolicitacao";
					$database->setQuery($sql);
	...
	<br />
	<span class="label label-inverse">Total de Solicitações: <b><?php echo sizeof($trancamentos);?></b></span>
	...
	function mostrarDetalhesTrancamento($aluno) {
        ...
        <form method="post" name="form" enctype="multipart/form-data" action="index.php?option=com_portalsecretaria&Itemid=<?php echo $Itemid;?>">
            ...
            <table width="100%" cellpadding="6">
                <tr style="background-color:#7196d8; font-weight:bold; color:#FFF;">
                ...
                <tr>
                    <td bgcolor="#CCCCCC"><b>Documento (s)</b></td>
