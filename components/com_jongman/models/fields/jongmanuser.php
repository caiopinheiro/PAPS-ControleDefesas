 ...
 * @since       2.0
 */
class JFormFieldJongmanUser extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_jongman&amp;view=users&amp;layout=modal&amp;tmpl=component&amp;field=' . $this->id
		...
		if ($this->element['readonly'] != 'true')
		{
			$html[] = '		<a class="modal_' . $this->id . '" title="' . JText::_('JLIB_FORM_CHANGE_USER') . '"' . ' href="' . $link . '"'
				. ' rel="{handler: \'iframe\', size: {x: 800, y: 400}}">';
