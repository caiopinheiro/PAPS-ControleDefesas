...
$(function() {
    ...
    /* Numeric message */
    var numericMsg = "O valor deve ser num&#233;rico!";
    /* minlength message */
    ...
    /* mascaras */
    $('head').append('<script src="components/com_ferias/jquery/js/jquery.mask.js" type="text/javascript"></script>');
    /* mascara data */
    ...
    //$('head').append('<link href="components/com_ferias/jquery/css/validate.css" type="text/css" media="screen" rel="stylesheet" />');
    /* button style - comentar alinha abaixo para omitir o style do button */
    $('head').append('<link href="components/com_ferias/jquery/css/button.css" type="text/css" media="screen" rel="stylesheet" />');
