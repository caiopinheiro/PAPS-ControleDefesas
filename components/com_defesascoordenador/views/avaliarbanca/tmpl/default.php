...
$emailconv = $this->emailconv;
$emailsoli = $this->emailsoli;



if(($sucesso == true) AND ($emailconv == true) AND ($emailsoli == NULL)){
	JFactory :: getApplication()->enqueueMessage(JText :: _('Opera&#231;&#227;o realizada com sucesso.'));
}
else if(($sucesso == false AND $sucesso != NULL ) OR (($emailconv ==false AND $emailconv !=NULL))){
	JError :: raiseWarning(100, 'ERRO: Opera&#231;&#227;o Falhou.');
}

if(($sucesso == true) AND ($emailconv == true AND $emailsoli == true)){
	JFactory :: getApplication()->enqueueMessage(JText :: _('Opera&#231;&#227;o realizada com sucesso.'));
}
else if(($sucesso == false AND $sucesso != NULL ) OR (($emailconv ==false AND $emailconv !=NULL) AND ($emailsoli == false AND $emailsoli != NULL))){
	JError :: raiseWarning(100, 'ERRO: Opera&#231;&#227;o Falhou.');
}

if($sucesso == true AND $sucesso2 == true){
	JFactory :: getApplication()->enqueueMessage(JText :: _('Opera&#231;&#227;o realizada com sucesso.'));
}
else if(($sucesso == false AND $sucesso != NULL) OR ($sucesso2 == false AND $sucesso2 != NULL)){
	JError :: raiseWarning(100, 'ERRO: Opera&#231;&#227;o Falhou.');
	...
	<table style='text-align: left; width: 100%;' border='1' cellpadding='3' cellspacing='0'>
      <tbody>
        <tr bgcolor='#B0B0B0'>
          ...
          <td style='text-align: center; font-weight: bold;' width='10%'>PASSAGEM</td>
        </tr>
        ...
        if(isset ($MembrosBanca)){
			...
			<tr>
			  ...
			  <td align='center'><?php if($membro->passagem == 'S'){ echo 'Sim';} else{echo 'Não';} ?></td>
