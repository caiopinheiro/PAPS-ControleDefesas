	...
	<table style="clear: both;width:100%;">
		...
		<tr>		
			...
			<?php if($this->showYear): ?>
				<th style="text-align:center;width:7%;"><?php echo JText::_('JRESEARCH_YEAR'); ?></th>
			<?php endif; ?>
			<th style="text-align:center;width:34%;"><?php echo JText::_('JRESEARCH_TITLE'); ?></th>
			<?php if($this->showAuthors): ?>
				<th style="text-align:center;width:17%;"><?php echo JText::_('JRESEARCH_AUTHORS'); ?></th>
			<?php endif; ?>
			<?php if($this->showResearchAreas): ?>
				<th style="text-align:center;width:12%;"><?php echo JText::_('JRESEARCH_RESEARCH_AREAS'); ?></th>			
			<?php endif; ?>
			...
			<?php endif; ?>
			<th style="text-align:center;width:17%;"><?php echo JText::_('JRESEARCH_AWARDS'); ?></th>
		</tr>
		</thead>
		...
		<tfoot>
			<tr>
				<td colspan="<?php echo $nCols; ?>">
				    <hr align="tr">
					<div><?php echo $this->page->getResultsCounter(); ?><br>
					<?php echo $this->page->getPagesLinks(); ?></div>
				</td>
			</tr>
		</tfoot>
		...
		?>
				<tr class="<?php $k = i%2; echo "row$k"; ?>">
					...
					<?php endif; ?>
					<td style="text-align:center"><?php echo $this->items[$i]->awards; ?></td>
