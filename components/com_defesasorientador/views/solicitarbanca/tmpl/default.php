...
<span class="icon-32-back"></span>Lista de</br>Defesas</a>
</div>
...
<table width="100%">
        ...
        <tr >
        <td>
        <label>Nome:</label> <input style="width:70%" type="text" name="nomeAluno" value="<?php echo $this->aluno[0]->nome;?>" disabled="disabled"/>
        </td>
        <td>
  ...
  (function($) {
	  AddTableRow = function() {
	    ...
	    cols += '<td>';
	    cols += '<button onclick="RemoveTableRow(this)" src="components/com_defesascoordenador/assets/images/excluir.png" type="button">Remover</button>';
	    cols += '</td>';
...
<table width="100%">
        ...
        <tr><td colspan="4"><label>Tem que haver mais dados aqui</label>
