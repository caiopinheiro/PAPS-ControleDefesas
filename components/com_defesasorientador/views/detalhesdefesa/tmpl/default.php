...
<script type="text/javascript" src= "/icomp/components/com_defesasorientador/assets/jquery-ui-1.11.2.custom/jquery-ui.js"></script>
...
<link rel="stylesheet" type="text/css" href="components/com_defesasorientador/assets/jquery-ui-1.11.2.custom/jquery-ui.css"> 	
...
<fieldset>
    <table>
    	<tbody>
            ...
            <tr>
            	<td><input type="text" name="dataDefesa" id="dataDefesa" maxlength="10" value="<?php echo formatarData($Defesa[0]->data); ?>" <?php if($isUpdate == '0') echo 'disabled'; ?> /></td>
