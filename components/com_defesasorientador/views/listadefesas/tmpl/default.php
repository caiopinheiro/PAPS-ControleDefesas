...
<script type="text/javascript">
    jQuery(function() {
        jQuery("#buscaDataDefesa").datepicker({
        dateFormat: 'dd/mm/yy',
    ...
    <fieldset>
        ...
        <table width="100%">
            ...
            <tr>                
                ...
                <td><input type="text" name="buscaDataDefesa" id="buscaDataDefesa" placeholder="dd/mm/aaaa" size="10" maxlength="10" value="<?php if (!is_null($data_defesa) || $data_defesa != '') echo $data_defesa;?>"/></td>
